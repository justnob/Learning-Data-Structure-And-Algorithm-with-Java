    ...
    public void insertInArray(int row, int col, int value){
        ...
        try{
            if(arr[row][col] == Integer.MIN_VALUE){
                ...
                arr[row][col] = value;
                System.out.println("Value Added In Array.Array");
            }
            else{

                System.out.println("Value Could Not Be Added In Array.Array");
...
//        Array.TwoDimArray sda = new Array.TwoDimArray(2,2);
//
